...
public class SimulationPlainsBiome extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:simulation_plains")
	public static final CustomBiome biome = null;
	public SimulationPlainsBiome(TeztDummiModModElements instance) {
		super(instance, 125);
	}
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			...
			setRegistryName("simulation_plains");
