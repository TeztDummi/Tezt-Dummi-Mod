...
import net.mcreator.teztdummimod.block.TeztIceBlock;
...
public class IcyTeztLandsBiome extends TeztDummiModModElements.ModElement {
	public static Biome biome;
	public IcyTeztLandsBiome(TeztDummiModModElements instance) {
		super(instance, 164);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-3342358).setWaterColor(-16730282).setWaterFogColor(-16751793)
						.withSkyColor(-3342358).withFoliageColor(-1).withGrassColor(-1).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(TeztIceBlock.block.getDefaultState(),
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.SNOW).category(Biome.Category.OCEAN).depth(0.1f).scale(0.01f)
						.temperature(0.1f).downfall(1f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("tezt_dummi_mod:icy_tezt_lands"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("icy_tezt_lands_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("icy_tezt_lands_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("icy_tezt_lands_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
