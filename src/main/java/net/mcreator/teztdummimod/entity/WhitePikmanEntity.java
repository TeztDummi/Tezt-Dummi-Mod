...
public class WhitePikmanEntity extends TeztDummiModModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("white_pikman").setRegistryName("white_pikman");
	public WhitePikmanEntity(TeztDummiModModElements instance) {
		super(instance, 208);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WhitePikmanRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -16751104, new Item.Properties().group(TeztDummiModItemGroup.tab))
				.setRegistryName("white_pikman_spawn_egg"));
	}
