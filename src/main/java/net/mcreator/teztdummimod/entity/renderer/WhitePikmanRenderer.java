...
@OnlyIn(Dist.CLIENT)
public class WhitePikmanRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WhitePikmanEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwhite_sus(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("tezt_dummi_mod:textures/whitepikman.png");
					}
				};
			});
		}
	...
	public static class Modelwhite_sus extends EntityModel<Entity> {
		private final ModelRenderer WhitePikman;
		...
		public Modelwhite_sus() {
			textureWidth = 64;
			textureHeight = 64;
			WhitePikman = new ModelRenderer(this);
			WhitePikman.setRotationPoint(0.0F, 15.0F, 0.0F);
			head = new ModelRenderer(this);
			head.setRotationPoint(0.0F, 0.0F, 0.0F);
			WhitePikman.addChild(head);
			head.setTextureOffset(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);
			head.setTextureOffset(0, 6).addBox(-3.0F, -6.0F, -4.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(4, 6).addBox(2.0F, -6.0F, -4.5F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(25, 16).addBox(1.0F, -5.0F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(28, 19).addBox(-3.0F, -5.0F, -4.5F, 2.0F, 2.0F, 1.0F, 0.0F, false);
		...
		public void render(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue,
				float alpha) {
			WhitePikman.render(matrixStack, buffer, packedLight, packedOverlay);
		}
