...
@OnlyIn(Dist.CLIENT)
public class WhitePenguinPillowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WhitePenguinPillowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelPenguin_Pillo(), 1f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("tezt_dummi_mod:textures/zpenguin_pillo_white.png");
					}
				};
			});
		}
