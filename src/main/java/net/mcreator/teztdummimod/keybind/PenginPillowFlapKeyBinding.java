...
import net.mcreator.teztdummimod.procedures.PenginPillowFlapOnKeyPressedProcedure;
...
public class PenginPillowFlapKeyBinding extends TeztDummiModModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
		...
		if (type == 0) {
			{
				...
				PenginPillowFlapOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
