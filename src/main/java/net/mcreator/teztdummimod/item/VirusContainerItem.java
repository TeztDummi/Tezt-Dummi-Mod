...
import net.mcreator.teztdummimod.procedures.VirusContainerRightClickedOnBlockProcedure;
...
public class VirusContainerItem extends TeztDummiModModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("virus_container");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				VirusContainerRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
