...
import net.mcreator.teztdummimod.procedures.TypinPickaxeBlockDestroyedWithToolProcedure;
	...
	public void initElements() {
		elements.items.add(() -> new PickaxeItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Press Y to change mode"));
			}
			...
			public boolean onBlockDestroyed(ItemStack itemstack, World world, BlockState bl, BlockPos pos, LivingEntity entity) {
				...
				int z = pos.getZ();
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					TypinPickaxeBlockDestroyedWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
