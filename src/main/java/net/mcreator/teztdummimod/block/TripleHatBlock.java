...
public class TripleHatBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:triple_hat")
	public static final Block block = null;
	public TripleHatBlock(TeztDummiModModElements instance) {
		super(instance, 199);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Idea by SMPB1"));
		}
