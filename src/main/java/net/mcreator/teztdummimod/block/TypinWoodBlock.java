...
public class TypinWoodBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:typin_wood")
	public static final Block block = null;
	public TypinWoodBlock(TeztDummiModModElements instance) {
		super(instance, 41);
	}
