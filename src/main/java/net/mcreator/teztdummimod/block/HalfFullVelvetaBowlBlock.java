...
import net.mcreator.teztdummimod.procedures.HalfFullVelvetaBowlOnBlockRightClickedProcedure;
...
public class HalfFullVelvetaBowlBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:half_full_velveta_bowl")
	public static final Block block = null;
	public HalfFullVelvetaBowlBlock(TeztDummiModModElements instance) {
		super(instance, 245);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("half_full_velveta_bowl");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				HalfFullVelvetaBowlOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
