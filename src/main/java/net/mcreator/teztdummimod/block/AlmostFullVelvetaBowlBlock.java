...
import net.mcreator.teztdummimod.procedures.AlmostFullVelvetaBowlOnBlockRightClickedProcedure;
...
public class AlmostFullVelvetaBowlBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:almost_full_velveta_bowl")
	public static final Block block = null;
	public AlmostFullVelvetaBowlBlock(TeztDummiModModElements instance) {
		super(instance, 244);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("almost_full_velveta_bowl");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				AlmostFullVelvetaBowlOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
