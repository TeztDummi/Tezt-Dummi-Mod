...
public class SansHatBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:sans_hat")
	public static final Block block = null;
	public SansHatBlock(TeztDummiModModElements instance) {
		super(instance, 196);
	}
