...
public class TeztyFlowerBlock extends TeztDummiModModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("tezty_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tezt_dummi_mod:tezty_flower"), configuredFeature);
		}
	}
	@SubscribeEvent
