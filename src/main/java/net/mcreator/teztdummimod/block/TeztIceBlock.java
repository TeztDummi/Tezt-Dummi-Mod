...
public class TeztIceBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:tezt_ice")
	public static final Block block = null;
	public TeztIceBlock(TeztDummiModModElements instance) {
		super(instance, 165);
	}
