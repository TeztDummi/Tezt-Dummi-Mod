...
public class TeztSandstoneBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:tezt_sandstone")
	public static final Block block = null;
	public TeztSandstoneBlock(TeztDummiModModElements instance) {
		super(instance, 219);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tezt_sandstone");
		}
