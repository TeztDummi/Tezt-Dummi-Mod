...
public class TypinLogBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:typin_log")
	public static final Block block = null;
	public TypinLogBlock(TeztDummiModModElements instance) {
		super(instance, 95);
	}
