...
import net.mcreator.teztdummimod.procedures.TeztaniumCraftingTableOnBlockRightClickedProcedure;
...
public class TeztaniumCraftingTableBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:teztanium_crafting_table")
	public static final Block block = null;
	public TeztaniumCraftingTableBlock(TeztDummiModModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("teztanium_crafting_table");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				TeztaniumCraftingTableOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
