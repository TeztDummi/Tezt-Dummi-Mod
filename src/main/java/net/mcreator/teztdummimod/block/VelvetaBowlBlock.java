...
import net.mcreator.teztdummimod.procedures.VelvetaBowlOnBlockRightClickedProcedure;
...
public class VelvetaBowlBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:velveta_bowl")
	public static final Block block = null;
	public VelvetaBowlBlock(TeztDummiModModElements instance) {
		super(instance, 243);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				VelvetaBowlOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
