...
public class TypinPlanksBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:typin_planks")
	public static final Block block = null;
	public TypinPlanksBlock(TeztDummiModModElements instance) {
		super(instance, 43);
	}
