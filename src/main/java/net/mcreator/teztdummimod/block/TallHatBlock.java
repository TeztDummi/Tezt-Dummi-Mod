...
public class TallHatBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:tall_hat")
	public static final Block block = null;
	public TallHatBlock(TeztDummiModModElements instance) {
		super(instance, 206);
	}
