...
public class TeztyFenceGateBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:tezty_fence_gate")
	public static final Block block = null;
	public TeztyFenceGateBlock(TeztDummiModModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("tezty_fence_gate");
		}
