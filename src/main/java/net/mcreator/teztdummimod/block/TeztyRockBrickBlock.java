...
public class TeztyRockBrickBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:tezty_rock_brick")
	public static final Block block = null;
	public TeztyRockBrickBlock(TeztDummiModModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tezty_rock_brick");
		}
