...
import net.mcreator.teztdummimod.procedures.SifterOnBlockRightClickedProcedure;
...
public class SifterBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:sifter")
	public static final Block block = null;
	public SifterBlock(TeztDummiModModElements instance) {
		super(instance, 228);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				SifterOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
