...
import net.mcreator.teztdummimod.procedures.AlmostEmptyVelvetaBowlOnBlockRightClickedProcedure;
...
public class AlmostEmptyVelvetaBowlBlock extends TeztDummiModModElements.ModElement {
	@ObjectHolder("tezt_dummi_mod:almost_empty_velveta_bowl")
	public static final Block block = null;
	public AlmostEmptyVelvetaBowlBlock(TeztDummiModModElements instance) {
		super(instance, 246);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("almost_empty_velveta_bowl");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				AlmostEmptyVelvetaBowlOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
