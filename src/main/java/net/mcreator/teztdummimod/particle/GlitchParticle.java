...
public class GlitchParticle extends TeztDummiModModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public GlitchParticle(TeztDummiModModElements instance) {
		super(instance, 133);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("glitch"));
	}
