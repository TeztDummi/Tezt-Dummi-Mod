...
package net.mcreator.teztdummimod.particle;
...
public class ZeroOneParticle extends TeztDummiModModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public ZeroOneParticle(TeztDummiModModElements instance) {
		super(instance, 168);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("zero_one"));
	}
	...
	private static class CustomParticle extends SpriteTexturedParticle {
		...
		public void tick() {
			super.tick();
			if (!this.isExpired) {
				this.setSprite(this.spriteSet.get((this.age / 30) % 2 + 1, 2));
			}
		}
	}
