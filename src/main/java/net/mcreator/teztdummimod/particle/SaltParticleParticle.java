...
public class SaltParticleParticle extends TeztDummiModModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public SaltParticleParticle(TeztDummiModModElements instance) {
		super(instance, 237);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("salt_particle"));
	}
